...
GHUNIT_CLI=1 xcodebuild -scheme IosSdkTests -destination 'platform=iOS Simulator,name=iPhone 6s' -configuration Debug -sdk iphonesimulator11.4 clean build 2>&1 | tee -a $bvtLogPath
