...
replace_number_or_hide_scheme "WindowsAzureMessaging.xcworkspace" false

# Sort schemes in modules projects.
replace_number_or_hide_scheme "WindowsAzureMessaging/WindowsAzureMessaging.xcodeproj" false

# Sort schemes in apps projects.
replace_number_or_hide_scheme "SampleNHAppLegacyObjC/SampleNHAppLegacyObjC.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppLegacySwift/SampleNHAppLegacySwift.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppMacObjC/SampleNHAppMacObjC.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppMacSwift/SampleNHAppMacSwift.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppMacSwiftUI/SampleNHAppMacSwiftUI.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppObjC/SampleNHAppObjC.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppSwift/SampleNHAppSwift.xcodeproj" false
replace_number_or_hide_scheme "SampleNHAppSwiftUI/SampleNHAppSwiftUI.xcodeproj" false
