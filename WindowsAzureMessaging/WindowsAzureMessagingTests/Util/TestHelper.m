...
+ (NSString *)verifyHttpRequest:(NSURLRequest *)request
                     httpMethod:(NSString *)expectedMethod
                            url:(NSString *)expectedUrl
                           body:(NSString *)expectedBody {
...
+ (NSString *)verifySASHttpRequest:(NSURLRequest *)request
                        httpMethod:(NSString *)expectedMethod
                               url:(NSString *)expectedUrl
                              body:(NSString *)expectedBody {
...
+ (NSString *)verifyACSHttpRequest:(NSURLRequest *)request
                        httpMethod:(NSString *)expectedMethod
                               url:(NSString *)expectedUrl
                              body:(NSString *)expectedBody {
    NSString *ret = [TestHelper verifyHttpRequest:request httpMethod:expectedMethod url:expectedUrl body:expectedBody];
...
+ (NSString *)verifyCustomizedTokenHttpRequest:(NSURLRequest *)request
                                    httpMethod:(NSString *)expectedMethod
                                           url:(NSString *)expectedUrl
                                          body:(NSString *)expectedBody {
    NSString *ret = [TestHelper verifyHttpRequest:request httpMethod:expectedMethod url:expectedUrl body:expectedBody];
