...
@interface WindowsAzureMessagingTests : XCTestCase
...
@implementation WindowsAzureMessagingTests
...
NSString *emptyRegistrations =
    @"<feed xmlns=\"http://www.w3.org/2005/Atom\"><title "
    @"type=\"text\">Registrations</title><id>https://testuser2-int7sn1007-1-8e72f-36.servicebus.int7.windows-int.net/"
    @"CreateWindowsRegistrationWithDifferentLocalStorageVersion-NotificationHub-rL9GkO/Registrations/"
    @"?$filter=channelUri%20eq%20'https%3A%2F%2Ftest.notify.windows.com%2F%3Ftoken%3DrFEXKubeJZrLYYtgIx5OFH62nimatX1U'&amp;api-version="
    @"2013-04</id><updated>2013-06-06T17:12:27Z</updated><link rel=\"self\" "
    @"href=\"https://testuser2-int7sn1007-1-8e72f-36.servicebus.int7.windows-int.net/"
    @"CreateWindowsRegistrationWithDifferentLocalStorageVersion-NotificationHub-rL9GkO/Registrations/"
    @"?$filter=channelUri%20eq%20'https%3A%2F%2Ftest.notify.windows.com%2F%3Ftoken%3DrFEXKubeJZrLYYtgIx5OFH62nimatX1U'&amp;api-version="
    @"2013-04\"/></feed>";
...
- (void)setUp {
    ...
    connectionStringSAS = [SBConnectionString stringWithEndpoint:[NSURL URLWithString:@"https://test.servicebus.windows.net/"]
                                                fullAccessSecret:@"myFullAccessPwd"];

    connectionStringACS = [SBConnectionString stringWithEndpoint:[NSURL URLWithString:@"sb://test.servicebus.windows.net"]
                                                          issuer:@"owner"
                                                    issuerSecret:@"GnxQQPqX2xwy72BE2Kmb/RvD58R1p7/NqVL9v8bmqC0="];
}
...
- (void)testConnectionString {
    NSString *conn =
        [SBConnectionString stringWithEndpoint:[NSURL URLWithString:@"sb://INT7-SN1-012Tinnu-0-10.servicebus.int7.windows-int.net/"]
                              fullAccessSecret:@"myFullAccessPwd"];

    if (![conn isEqualToString:@"Endpoint=sb://INT7-SN1-012Tinnu-0-10.servicebus.int7.windows-int.net/"
                               @";SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=myFullAccessPwd"]) {
        XCTFail(@"Fail at connectionString for full accessSecret.");
        return;
    }

    conn = [SBConnectionString stringWithEndpoint:[NSURL URLWithString:@"sb://INT7-SN1-012Tinnu-0-10.servicebus.int7.windows-int.net/"]
                               listenAccessSecret:@"myListenAccessPwd"];
    if (![conn isEqualToString:@"Endpoint=sb://INT7-SN1-012Tinnu-0-10.servicebus.int7.windows-int.net/"
                               @";SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=myListenAccessPwd"]) {
    ...
    conn = [SBConnectionString stringWithEndpoint:[NSURL URLWithString:@"sb://INT7-SN1-012Tinnu-0-10.servicebus.int7.windows-int.net/"]
                                     ...
                                     issuerSecret:@"GnxQQPqX2xwy72BE2Kmb/RvD58R1p7/NqVL9v8bmqC0="];
    if (![conn isEqualToString:@"Endpoint=sb://INT7-SN1-012Tinnu-0-10.servicebus.int7.windows-int.net/"
                               @";SharedSecretIssuer=owner;SharedSecretValue=GnxQQPqX2xwy72BE2Kmb/RvD58R1p7/NqVL9v8bmqC0="]) {
...
- (void)testInvalidConnectionString {
    SBNotificationHub *notificationHub = [[SBNotificationHub alloc] initWithConnectionString:@"wrongConnectionString"
                                                                         notificationHubPath:path];
    if (notificationHub) {
...
- (void)testCreateRegistrationWithSameStorageVersion {
...

    {
        [SBURLConnection setStaticHandler:^SBStaticHandlerResponse *(NSURLRequest *request) {
          if (!createRegistrationIdRequestFinished) {
              NSString *ret =
                  [TestHelper verifySASHttpRequest:request
                                        httpMethod:@"POST"
                                               url:@"https://test.servicebus.windows.net/PushTest/registrationids/?api-version=2013-04"
                                              body:@""];
              ...
              NSString *ret = [TestHelper
                  verifySASHttpRequest:request
                            httpMethod:@"PUT"
                                   url:@"https://test.servicebus.windows.net/PushTest/Registrations/73838-337-2383?api-version=2013-04"
                                  body:@"<entry xmlns=\"http://www.w3.org/2005/Atom\"><content "
                                       @"type=\"text/xml\"><AppleRegistrationDescription "
                                       @"xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" "
                                       @"xmlns=\"http://schemas.microsoft.com/netservices/2010/10/servicebus/connect\"><Tags>Tag2,Tag1</"
                                       @"Tags><DeviceToken>3131</DeviceToken></AppleRegistrationDescription></content></entry>"];
    ...
    NSLog(@"3. registerTemplate");
    {
                  ...
                  verifySASHttpRequest:request
                            httpMethod:@"PUT"
                                  ...
                                  body:@"<entry xmlns=\"http://www.w3.org/2005/Atom\"><content "
                                       ...
                                       @"xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" "
                                       @"xmlns=\"http://schemas.microsoft.com/netservices/2010/10/servicebus/connect\"><Tags>tag4,tag3</"
                                       @"Tags><DeviceToken>3131</"
                                       @"DeviceToken><BodyTemplate><![CDATA[{\"aps\":{\"alert\":\"$(GotMail)\",\"badge\":10, "
                                       @"\"sound\":\"bingbong.aiff\"},\"acme\":\"My "
                                       @"data\"}]]></BodyTemplate><Expiry>$(expiry)</Expiry><TemplateName>MyReg2</TemplateName></"
        ...
        createRegistrationIdRequestFinished = FALSE;
        httpRequestFinished = FALSE;
        [notificationHub registerTemplateWithDeviceToken:deviceToken
                                                    name:@"MyReg2"
                                        jsonBodyTemplate:jsonBody
                                          expiryTemplate:@"$(expiry)"
                                                    tags:[NSSet setWithArray:@[ @"tag3", @"tag4" ]]
                                                   error:nil];
...

    {
        [SBURLConnection setStaticHandler:^SBStaticHandlerResponse *(NSURLRequest *request) {
          NSString *ret = [TestHelper
              verifySASHttpRequest:request
                        httpMethod:@"PUT"
                               url:@"https://test.servicebus.windows.net/PushTest/Registrations/myRegId1?api-version=2013-04"
                              body:@"<entry xmlns=\"http://www.w3.org/2005/Atom\"><content type=\"text/xml\"><AppleRegistrationDescription "
                                   @"xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" "
                                   @"xmlns=\"http://schemas.microsoft.com/netservices/2010/10/servicebus/connect\"><Tags>Tag2,Tag1</"
                                   @"Tags><DeviceToken>3131</DeviceToken></AppleRegistrationDescription></content></entry>"];
    ...
    NSLog(@"3. registerTemplate");
    {
        [SBURLConnection setStaticHandler:^SBStaticHandlerResponse *(NSURLRequest *request) {
          NSString *ret =
              [TestHelper verifySASHttpRequest:request
                                    httpMethod:@"PUT"
                                           url:@"https://test.servicebus.windows.net/PushTest/Registrations/myRegId2?api-version=2013-04"
                                          body:@"<entry xmlns=\"http://www.w3.org/2005/Atom\"><content "
                                               @"type=\"text/xml\"><AppleTemplateRegistrationDescription "
                                               @"xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" "
                                               @"xmlns=\"http://schemas.microsoft.com/netservices/2010/10/servicebus/"
                                               @"connect\"><Tags>tag4,tag3</Tags><DeviceToken>3131</"
                                               @"DeviceToken><BodyTemplate><![CDATA[{\"aps\":{\"alert\":\"$(GotMail)\",\"badge\":10, "
                                               @"\"sound\":\"bingbong.aiff\"},\"acme\":\"My "
                                               @"data\"}]]></BodyTemplate><Expiry>$(expiry)</Expiry><TemplateName>regName</TemplateName></"
                                               @"AppleTemplateRegistrationDescription></content></entry>"];
...
- (void)testCreateRegistrationWithEmptyStorageVersion {
    ...
    [SBURLConnection setStaticHandler:^SBStaticHandlerResponse *(NSURLRequest *request) {
      if (!refreshRequestFinished) {
          NSString *ret = [TestHelper verifySASHttpRequest:request
                                                httpMethod:@"GET"
                                                       url:@"https://test.servicebus.windows.net/PushTest/Registrations/"
                                                           @"?$filter=deviceToken+eq+'3131'&api-version=2013-04"
                                                      body:@""];
    ...
    NSLog(@"1. registerNative");
    {
        ...
        SBNotificationHub *notificationHub = [[SBNotificationHub alloc] initWithConnectionString:connectionStringSAS
                                                                             notificationHubPath:path];
              ...
              verifySASHttpRequest:request
                        httpMethod:@"PUT"
                              ...
                              body:
                                  ...
                                  @"DeviceToken><BodyTemplate><![CDATA[{\"aps\":{\"alert\":\"$(GotMail)\",\"badge\":10, "
                                  @"\"sound\":\"bingbong.aiff\"},\"acme\":\"My "
                                  @"data\"}]]></BodyTemplate><Expiry>$(expiry)</Expiry><Priority>$(priority)</"
                                  @"Priority><TemplateName>MyReg2</TemplateName></AppleTemplateRegistrationDescription></content></entry>"];
...

    {
        [SBURLConnection setStaticHandler:^SBStaticHandlerResponse *(NSURLRequest *request) {
          if (!tokenRequestFinished) {
              NSString *ret =
                  [TestHelper verifyHttpRequest:request
                                     httpMethod:@"POST"
                                            url:@"https://test-sb.accesscontrol.windows.net/WRAPv0.9/"
                                           body:@"wrap_scope=http%3A%2F%2Ftest.servicebus.windows.net%2Fpushtest%2Fregistrations%"
                                                @"2Fmyregid1&wrap_assertion_format=SWT&wrap_assertion=Issuer%3Downer%26HMACSHA256%"
                                                @"3Dje1Q5mR%252FmLmbz%252Bio5k%252FuuJ8l4CM5EIb9uN73iZfCHgk%253D"];
              ...
              NSString *ret =
                  [TestHelper verifyHttpRequest:request
                                     httpMethod:@"POST"
                                            url:@"https://test-sb.accesscontrol.windows.net/WRAPv0.9/"
                                           body:@"wrap_scope=http%3A%2F%2Ftest.servicebus.windows.net%2Fpushtest%2Fregistrations%"
                                                @"2Fmyregid2&wrap_assertion_format=SWT&wrap_assertion=Issuer%3Downer%26HMACSHA256%"
                                                @"3Dje1Q5mR%252FmLmbz%252Bio5k%252FuuJ8l4CM5EIb9uN73iZfCHgk%253D"];
