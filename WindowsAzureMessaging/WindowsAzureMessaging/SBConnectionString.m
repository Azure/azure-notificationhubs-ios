...
static NSString *const defaultListenSasRuleName = @"DefaultListenSharedAccessSignature";
static NSString *const defaultFullSasRuleName = @"DefaultFullSharedAccessSignature";
