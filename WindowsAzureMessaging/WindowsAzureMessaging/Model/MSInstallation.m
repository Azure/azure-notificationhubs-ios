...
- (BOOL)isEqualToMSInstallation:(MSInstallation *)installation {
    ...
    BOOL isExpirationTimeEqual = (!self.expirationTime && !installation.expirationTime) || (self.expirationTime && installation.expirationTime && [[NSCalendar currentCalendar] isDate:self.expirationTime equalToDate:installation.expirationTime toUnitGranularity:NSCalendarUnitDay]);
