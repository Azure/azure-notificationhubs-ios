...
+ (ANHTokenProvider *)createFromConnectionDictionary:(NSDictionary *)connectionDictionary {
    return [[ANHTokenProvider alloc] initWithConnectionDictionary:connectionDictionary];
}
